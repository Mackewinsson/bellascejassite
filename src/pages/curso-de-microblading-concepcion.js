...
const curso = coursesData.courses[2]
const modalidad = curso.modalidades

const cursodemicrobladingconcepcion = () => {
  return (
    <>
      <SEO title="Curso de Microblading en concepción" />
      <Container>
...
export default cursodemicrobladingconcepcion
